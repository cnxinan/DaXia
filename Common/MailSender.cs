...
namespace DaXia.Common
{
    public class MailSender
    {
        ...
        public static void MailSend(string subject, string body, string toMail)
        {
            ...
            try
            {
                ...
                smtp.Credentials = new NetworkCredential("xazylm@163.com", "zylmcomcn");
                smtp.Port = 25;
                MailAddress from = new MailAddress("xazylm@163.com");
